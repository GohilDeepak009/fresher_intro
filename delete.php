...
<div class="header">
<p><a href="index.php">View Fresher</a> OR <a href="add.php">Introduce Myself</a> OR <a href="update.php">Update Intro</a></p>
</div>
<footer>
    <p class="attribution">
...
$query = "DELETE FROM `intro` WHERE `intro`.`id` = $id";
...
if($result)
{
    echo '<script>alert("Your Details are Deleting Successfully");</script>';
}
else
{
    echo '<script>alert("Something went wrong while deleting your details");</script>';
}
